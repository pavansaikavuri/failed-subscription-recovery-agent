...
**[View the full report in your browser](https://htmlpreview.github.io/?https://github.com/pavansaikavuri/failed-subscription-recovery-agent/blob/main/benchmark_report.html)**
— or open `benchmark_report.html` locally. Both are generated by
`python pipeline.py --benchmark`, offline, with no API key.
